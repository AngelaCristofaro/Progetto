      ...
      <nav class="navbar navbar-default colore">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="home.html"><img src="noleggio.png"  class="img-responsive" id="logo"></a>
          </div>
...
<!--               <li><a class="Bcol" href="#"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li> -->
